...
def ms_fcnn():
    ...
    base_model = vgg16.VGG16(include_top=False, weights='imagenet', pooling='max', input_shape=(256, 256, 3))
    ...
    adam_optimizer = keras.optimizers.Adam(lr=0.002, beta_1=0.9, beta_2=0.999, epsilon=1e-8)
    end2end.compile(optimizer=adam_optimizer, loss=weighted_pixelwise_crossentropy)
    ...
    with open("vgg16_saliency.json", "w") as json_file:
